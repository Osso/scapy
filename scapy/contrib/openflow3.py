...
class OFPTPacketOut(_ofp_header):
    ...
    fields_desc = [ByteEnumField("version", 0x04, ofp_version),
                   ...
                   FieldLenField(
        "actions_len", None, fmt="H", length_of="actions"),
        XBitField("pad", 0, 48),
        ActionPacketListField("actions", [], Packet,
...
class OFPMPReplyGroupFeatures(_ofp_header):
    ...
    fields_desc = [ByteEnumField("version", 0x04, ofp_version),
                   ...
                   FlagsField(
        "actions_select", 0, 32, ofp_action_types_flags),
        FlagsField(
        "actions_indirect", 0, 32, ofp_action_types_flags),
...
class OFPTGetAsyncReply(_ofp_header):
    ...
    fields_desc = [ByteEnumField("version", 0x04, ofp_version),
                   ...
                   IntField("xid", 0),
                   FlagsField(
        "packet_in_mask_master", 0, 32, ofp_packet_in_reason),
        FlagsField(
        "packet_in_mask_slave", 0, 32, ofp_packet_in_reason),
        FlagsField(
        "port_status_mask_master", 0, 32, ofp_port_reason),
        FlagsField(
        "port_status_mask_slave", 0, 32, ofp_port_reason),
        FlagsField(
